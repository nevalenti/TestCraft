  ...
  return (
    <div ref={ref} className="relative">
      {hasLabels ? (
        <button
          type="button"
          className="btn text-base-content/40 btn-ghost btn-xs hover:text-base-content/70"
          onClick={() => setOpen((v) => !v)}
        ...
        <button
          type="button"
          className="flex items-center gap-1.5 rounded-md border border-dashed border-base-content/20 px-2 py-1 text-[11px] font-medium text-base-content/50 transition-colors hover:border-base-content/40 hover:text-base-content/70"
          onClick={() => setOpen((v) => !v)}
        ...
        <>
          ...
          <div className="absolute top-full left-0 z-20 mt-1.5 w-56 overflow-hidden rounded-xl border border-border bg-base-100 shadow-xl">
            <div className="border-b border-border px-3 py-2">
              <p className="text-[11px] font-semibold tracking-wide text-base-content/50 uppercase">
                Labels
              </p>
            </div>
