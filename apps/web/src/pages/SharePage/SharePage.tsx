  ...
  return (
    <div className="min-h-screen bg-base-200">
      <div className="mx-auto max-w-4xl px-4 py-10">
        ...
        {run.environment && (
          <p className="mt-1 text-sm text-base-content/70">{run.environment}</p>
        )}
            ...
            <tbody>
              {(run.results ?? []).map((result, idx) => (
                <tr key={idx} className="hover">
                  ...
                  <td className="text-xs text-base-content/60 tabular-nums">
                    {formatDuration(result.durationMs)}
                  </td>
                  <td className="text-xs whitespace-nowrap text-base-content/60 tabular-nums">
