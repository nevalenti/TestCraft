...
namespace TestCraft.Application.ShareTokens.Queries.GetRunByShareToken;

public record GetRunByShareTokenQuery(string Token) : IRequest<SharedRunResponse>;

public class GetRunByShareTokenQueryHandler(IApplicationDbContext context)
    : IRequestHandler<GetRunByShareTokenQuery, SharedRunResponse>
{
    public async Task<SharedRunResponse> Handle(
        GetRunByShareTokenQuery request,
