...
registry.registerPath({
  ...
  responses: { 200: json(z.array(ProjectSchema), "Projects"), 401: r401 },
});
...
registry.registerPath({
  ...
  responses: { 200: json(z.array(TestSuiteSchema), "Test suites"), 401: r401 },
});
...
registry.registerPath({
  ...
  responses: { 200: json(z.array(TestCaseSchema), "Test cases"), 401: r401 },
});
...
registry.registerPath({
  ...
  responses: {
    200: json(z.array(TestCaseStepSchema), "Test case steps"),
    401: r401,
  },
});
...
registry.registerPath({
  ...
  security: auth,
  request: { params: projectIdParam },
  responses: { 200: json(z.array(TestRunSchema), "Test runs"), 401: r401 },
});
...
registry.registerPath({
  ...
  responses: {
    200: json(z.array(TestResultSchema), "Test results"),
    401: r401,
  },
});
