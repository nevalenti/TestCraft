...
<@layout.registrationLayout displayMessage=displayMessage pageTitle="TestCraft - Sign up">
  <div class="rounded-xl bg-base-100 shadow-md px-6 py-8 sm:px-8 sm:py-10" style="border: 1px solid var(--color-border);">
    <div class="mb-6">
      ...
      <p class="mt-2 text-center text-sm text-base-content/55">Join TestCraft to get started</p>
    </div>
    ...
    <form id="kc-register-form" onsubmit="document.getElementById('kc-register').disabled=true; return true;" action="${url.registrationAction}" method="post" class="space-y-4">
      <div class="grid grid-cols-2 gap-3">
        <div>
          <label for="firstName" class="block text-sm font-semibold mb-1.5 text-base-content">First name</label>
        ...
        <div>
          <label for="lastName" class="block text-sm font-semibold mb-1.5 text-base-content">Last name</label>
      ...
      <div>
        <label for="email" class="block text-sm font-semibold mb-1.5 text-base-content">Email address</label>
        <input id="email" name="email" type="email" value="${(register.formData.email!'')}" autocomplete="email" placeholder="you@example.com" class="input input-bordered w-full h-10 text-sm" />
      </div>

      <div>
        <label for="password" class="block text-sm font-semibold mb-1.5 text-base-content">Password</label>
      ...
      <div>
        <label for="password-confirm" class="block text-sm font-semibold mb-1.5 text-base-content">Confirm password</label>
