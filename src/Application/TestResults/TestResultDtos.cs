...
public record TestResultDto(Guid Id, Guid TestRunId, Guid TestCaseId, TestResultStatus Status, string? Notes, DateTime ExecutedAt, Guid? ExecutedById, DateTime CreatedAt, DateTime? UpdatedAt);
